...
export default function UserDashboard() {
    ...
    try {
      ...
      for (let i = 0; i < clientIds.length; i++) {
        ...
        const workerRes = await fetch(
          "/api/inbox/get-worker-details?workerId=" + id
        );
        ...
        if (workerDetails) {
          clientDetails[id] = {
            ...
            photoURL:
              workerDetails.worker.user.profile_pic ||
              "/images/user_default_profile.webp",
          };
        }
      }
  ...
  const selectConversation = (conversation) => {
    ...
    if (conversation.unreadCount > 0) {
      ...
      const convRef = ref(
        db,
        `workerConversations/${workerId}/${conversation.clientId}/unreadCount`
      );
      set(convRef, 0);
    }
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const workerConvRef = ref(
        db,
        `workerConversations/${userIDS[1]}/${userIDS[0]}`
      );
      ...
      const clientConvRef = ref(
        db,
        `clientConversations/${userIDS[0]}/${userIDS[1]}`
      );
      ...
      try {
        switch (activeTab) {
          ...
          case "messages":
            if (!workerId) {
              const worker = await (
                await fetch("/api/inbox/get-user-id")
              ).json();
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white border border-[gainsboro] rounded-[10px] p-4 flex items-center">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {dashboardStats.canceledProjects}
                  </p>
                </div>
              </div>
              ...
              <div className="fixed inset-0 z-50 flex items-start justify-center bg-[#0000008c] overflow-y-auto">
                <div className="bg-white rounded-lg p-6 shadow-lg w-full max-w-2xl mt-[30px] mb-[30px]">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                          ...
                          <div className="flex items-center mb-2">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-500">
                                ...
                                {selectedProject.worker.reviews} reviews)
                              </div>
                            </div>
                          </div>
                          <div className="text-sm">
                            <div className="mb-1">
                              ...
                              <span className="ml-2">
                                {selectedProject.worker.skills.join(", ")}
                              </span>
                            </div>
                            <div>
                              ...
                              <span className="ml-2">
                                {new Date(
                                  selectedProject.worker.joined_date
                                ).toLocaleDateString()}
                              </span>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <span
                              ...
                              ${
                                selectedProject.payment_status === "PAID"
                                  ? "bg-green-100 text-green-800"
                                  : selectedProject.payment_status === "FAILED"
                                  ? "bg-red-100 text-red-800"
                            ...
                            >
                              {selectedProject.payment_status
                                ? selectedProject.payment_status.toLowerCase()
                                : "unpaid"}
                            </span>
                          </div>
                  ...
                  <div className="flex justify-end gap-3">
                    ...
                    {selectedProject.status === "completed" &&
                      selectedProject.user_confirmed === false && (
                        <button
                          onClick={() => {
            ...
            {selectedConversation ? (
              <div className="flex flex-col h-[500px]">
                    ...
                    <div className="flex items-center">
                      <img
                        src={
                          ...
                          ]?.photoURL || "/images/user_default_profile.webp"
                        }
                        alt="Client"
                        className="w-10 h-10 rounded-full mr-3"
                      />
                ...
                <form
                  ...
                  className="p-4 pb-0 border-t border-gray-200 bg-white"
                >
              ...
              <div className="space-y-4">
                {loadingConversations ? (
                  ...
                  <div className="text-center py-10 text-gray-500">
                    No conversations yet. You can send a message to worker on
                    explore page.
                  </div>
                ) : (
                  conversations.map((conversation) => (
                    ...
                    >
                      <div className="flex items-center">
                        <img
                          src={
                            clients[conversation.clientId]?.photoURL ||
                            "/images/user_default_profile.webp"
                          }
                          alt="Client"
                        ...
                        <div className="flex-1">
                          ...
                          >
                            {`${
                              conversation.senderType === "worker"
                                ? "Worker: "
                                : "Anda: "
                            }${
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="flex flex-row w-full max-w-screen-xl mx-auto p-4 md:p-6 gap-6">
        ...
        <div
          className="flex-grow"
          style={{ width: "calc(100% - 256px - 1.5rem)" }}
        >
